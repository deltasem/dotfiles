...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey     }, "v", function () awful.util.spawn("/usr/bin/vifm")          end,
              {description = "launch vifm", group = "launcher"}),
    awful.key({ modkey     }, "b", function () awful.spawn(browser)          end,
              {description = "launch Browser", group = "launcher"}),
    awful.key({ modkey, "Control"}, "Escape", function () awful.spawn("/usr/bin/rofi -show drun -modi drun,run,ssh,window,windowcd,combi,keys") end,
